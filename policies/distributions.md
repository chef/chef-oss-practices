...
However, if you add a new class or create a derived class, the name of that new class should not include a Trademark.
...
Yes. For example the Chef gem can function as a library, rather than an executable. It is fine to reference the Chef gem as a library from your code, but derived and modified class names should not include Chef trademarks.
...
## Can Progress evaluate my distribution to make sure its following the trademark guidelines?
